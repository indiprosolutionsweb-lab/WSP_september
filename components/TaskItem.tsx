...
export const TaskItem: React.FC<TaskItemProps> = ({ task, onUpdateTask, onDeleteTask, canEdit, allProfiles, onMoveToUpcoming }) => {
                    ...
                    <div className="flex items-center space-x-1">
                        ...
                        >
                            {Object.values(TaskStatus)
                                .filter(status => status !== TaskStatus.InProgress)
                                .map(status => (
